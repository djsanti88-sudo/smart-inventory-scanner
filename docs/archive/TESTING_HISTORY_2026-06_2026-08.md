# Testing history (frozen archive, 2026-08-19)

> Verbatim historical proof-run sections split out of the root TESTING.md during the root-docs
> refresh. Dated 2026-06 to 2026-08; NOT re-verified as current. The living coverage maps stay in
> the root TESTING.md.
