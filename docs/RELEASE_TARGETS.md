...
| Stable authenticated preview | `inventory-preview-sharpenly.vercel.app` |
...
5. The stable preview must pass authenticated onboarding, scan, sync, history, and tenant-isolation
   checks.
