...
- **De-branding** customer-facing UI: "AI lookup"/"AI decode"/Gemini/OpenAI/Firecrawl/provider -> "Lookup"/"Decoding"/"Product search"/"Suggested product"/"Match confidence". platformOwner diagnostics keep provider details.
