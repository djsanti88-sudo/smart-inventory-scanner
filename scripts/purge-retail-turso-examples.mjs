...
// guard (src/services/ai/decode.ts isExampleOrTestRow, wired into src/server/decode/pipeline.ts and
...
// EXAMPLE_BARCODE_BLOCKLIST in src/services/ai/decode.ts and scripts/build-retail-knowledge.mjs.
