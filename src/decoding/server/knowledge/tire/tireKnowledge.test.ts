...
import { lookupByExactBarcode, lookupByExactPartNumber, getTireKnowledgeMeta, __resetTireKnowledgeCacheForTests } from "@/decoding/server/knowledge/tire/tireKnowledgeIndex";
