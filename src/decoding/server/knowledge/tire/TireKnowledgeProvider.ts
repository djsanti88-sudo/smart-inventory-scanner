...
import { lookupByExactBarcode, lookupByExactPartNumber, type TireKnowledgeRow } from "@/decoding/server/knowledge/tire/tireKnowledgeIndex";
import { lookupTrustedExactBarcode } from "@/decoding/server/knowledge/tire/tireExactIndex";
