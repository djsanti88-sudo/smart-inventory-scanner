...
vi.mock("@/decoding/server/knowledge/tire/tireKnowledgeIndex", async (importOriginal) => {
  const actual = await importOriginal<typeof import("@/decoding/server/knowledge/tire/tireKnowledgeIndex")>();
  return {
    ...actual,
