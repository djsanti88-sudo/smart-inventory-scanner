...
import { getTursoClient as getRetailTursoClient, type TursoClient } from "@/decoding/server/knowledge/retail/retailKnowledgeIndex";
...
const META_PATH = join(process.cwd(), "src", "decoding", "server", "knowledge", "tire", "tireKnowledge.generated.meta.json");
...
const TIRE_JSON_PATH = join(process.cwd(), "src", "decoding", "server", "knowledge", "tire", "tireKnowledge.generated.json");
