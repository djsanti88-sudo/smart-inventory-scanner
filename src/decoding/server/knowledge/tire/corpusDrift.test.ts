...
import { lookupByExactBarcode, getTireKnowledgeMeta, __resetTireKnowledgeCacheForTests } from "@/decoding/server/knowledge/tire/tireKnowledgeIndex";
...
const GENERATED_JSON_PATH = join(process.cwd(), "src", "decoding", "server", "knowledge", "tire", "tireKnowledge.generated.json");
