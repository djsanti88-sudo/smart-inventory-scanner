...
// DT-1 (2026-08-13) retail counterpart to src/decoding/server/knowledge/tire/corpusDrift.test.ts. The tire
...
const OUT_DIR = join(process.cwd(), "src", "decoding", "server", "knowledge", "retail");
