// src/reconcile/adapters/universalAdapter.ts
//
// Universal (XLSX/TSV/CSV) intake adapter for the reconcile round. Converts an ALREADY-PARSED
// UniversalSheet (see @/import/universalFileReader, read-only dependency) plus a resolved
// ColumnMapping (see @/import/columnIntelligence's inferColumnMapping, read-only dependency -
...
import type { ColumnMapping, UniversalSheet } from "@/import/importSchema";
