...
import { candidateKnownUpcSet, shopReverseUpcConflict, type UpcRecord } from "@/products/catalog/candidateUpcSet";
...
describe("shopReverseUpcConflict (shop-catalog reverse-UPC guard, Phase 1)", () => {
