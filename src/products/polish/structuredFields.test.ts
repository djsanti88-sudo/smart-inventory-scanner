...
import { structuredFieldsFor, safeStructuredFieldsFor } from "@/products/polish/structuredFields";
...
describe("safeStructuredFieldsFor", () => {
  ...
  it("never throws: a structurer crash returns an empty patch instead", async () => {
    const structurerModule = await import("@/products/polish/structurer");
