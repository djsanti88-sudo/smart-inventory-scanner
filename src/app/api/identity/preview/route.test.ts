...
describe("POST /api/identity/preview", () => {
  ...
  it("accepts only a bounded JSON preview request and delegates through injected local dependencies", async () => {
    ...
    const body = { rows: [{ businessId: "demo-shop" }], orderedMappings: [], sourceFileHashes: [], importerVersion: "v1", issuedAt: "2026-07-31T00:00:00.000Z", expiresAt: "2026-07-31T00:10:00.000Z" };
