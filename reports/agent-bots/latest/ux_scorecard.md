...
| Export the final count | PASS | 2 | P2 | no | export in unified Export menu |
| Understand Needs Review | PASS | 3 | P2 | yes | page exists; copy could be plainer for a new user |
| Use the scan page on a phone-width screen | PASS | 3 | P2 | no | scan input still reachable at 390px |

Screenshots: e2e/proof/agent-bots/ux/
