...
A2: The full handoff gate: `tsc` + eslint (src + e2e) + `next build` + mock E2E + `test:firebase` + `qa:bots`. Source: docs/COMMANDS.md "E2E (Playwright)" table row for `qa:revision`; docs/QA_BOTS.md.
...
A11: `src/shared/privacy/keySafety.test.ts`. Source: docs/COMMANDS.md "Environment variables" intro paragraph; docs/FIREBASE.md "Credential boundary"; CLAUDE.md "Data Privacy" section.
