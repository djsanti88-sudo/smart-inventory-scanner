...
// Screenshots: e2e/proof/gpt-decode/.

const PROOF = "e2e/proof/gpt-decode";
...
const gptVerifiedPayload = (code: string, n: number) => ({
  ...
  decision: {
    status: "suggested", confidence: 0.9, reason: "AI identity self-report, not app-verified",
  ...
  reasonText: "AI identity suggested for review",
  timedOut: false,
  debug: {},
});
